...
export default async function AdminEventsPage() {
  ...
  const events = await prisma.event.findMany({ where: branchScopedWhere(user), include: { branch: true }, orderBy: { startDate: "desc" } }).catch(() => []);
  return (
    <div>
