...
export default async function AdminBranchesPage() {
  ...
  const branches = await prisma.branch.findMany({ orderBy: [{ sortOrder: "asc" }, { city: "asc" }] }).catch(() => []);
  return (
    <div>
